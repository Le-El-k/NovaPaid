// Auto-generated by scripts/generate-sw.js on 2026-09-21T16:34:19.101Z
// Build Version: 016e6e7-1790008459101
// Commit: 016e6e7

const CACHE_NAME = "nova-pay-pwa-016e6e7-1790008459101";
const BUILD_VERSION = "016e6e7-1790008459101";
...
const APP_SHELL = [
  ...
  `${basePath}/novapaid-logo-192.png`,
  `${basePath}/novapaid-logo-512.png`,
  `${basePath}/novapaid-logo-32.png`,
  `${basePath}/novapaid-logo-96.png`,
  `${basePath}/novapaid-logo-180.png`,
  `${basePath}/novapay-logo.png`,
  ...
  event.waitUntil(
    caches.keys()
      .then((cacheNames) => Promise.all(
        cacheNames
          .filter((cacheName) => cacheName.startsWith("nova-pay-pwa-") && cacheName !== CACHE_NAME)
          .map((cacheName) => {
